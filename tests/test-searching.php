...
class Tests_Searching extends SearchPress_UnitTestCase {
	...
	function test_invalid_sorting() {
		$es_args = SP_WP_Search::wp_to_es_args(
			array(
				'orderby' => 'modified',
				'order'   => 'desc',
			)
		...
		$this->assertEquals(
			...
			$this->search_and_get_field(
				array(
					'date_range' => array(
						'field' => 'post_date',
						'gte'   => '2009-11-01 00:00:00',
						'lt'    => '2009-12-01 00:00:00',
					),
				)
			)
		);
	...
	function test_search_get_posts() {
		...
		$sp_posts = sp_wp_search(
			array(
				'terms'   => array( 'post_tag' => 'tag-a' ),
				'orderby' => 'id',
				'order'   => 'asc',
			)
		);
	...
	function test_query_author_vars() {
		$author_1 = $this->factory->user->create(
			array(
				'user_login' => 'author1',
				'user_pass'  => rand_str(),
				'role'       => 'author',
		...
		$post_1   = $this->factory->post->create(
			array(
				...
				'post_date'   => '2006-01-04 00:00:00',
			)
		);

		$author_2 = $this->factory->user->create(
			array(
				'user_login' => 'author2',
				'user_pass'  => rand_str(),
				'role'       => 'author',
		...
		$post_2   = $this->factory->post->create(
			array(
				...
				'post_date'   => '2006-01-03 00:00:00',
			)
		);

		$author_3 = $this->factory->user->create(
			array(
				'user_login' => 'author3',
				'user_pass'  => rand_str(),
				'role'       => 'author',
		...
		$post_3   = $this->factory->post->create(
			array(
				...
				'post_date'   => '2006-01-02 00:00:00',
			)
		);

		$author_4 = $this->factory->user->create(
			array(
				'user_login' => 'author4',
				'user_pass'  => rand_str(),
				'role'       => 'author',
